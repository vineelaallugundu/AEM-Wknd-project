...
MapTo('wknd/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('wknd/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
...
LazyMapTo('wknd/components/teaser')(TeaserV1Component);
...
LazyMapTo('wknd/components/carousel')(CarouselV1Component);
...
LazyMapTo('wknd/components/text')(LazyTextModule, TextEditConfig);